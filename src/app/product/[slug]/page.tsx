...
import { formatPrice, getProductIdWithSlug } from "@/lib/utils";
...
const ProductPage = async ({ params }: TProductPageProps) => {
	...
	const productId = getProductIdWithSlug(slug);
			...
			<div className="bg-gradient-to-r from-red-500/10 to-red-600/10 py-6 px-4">
				<div className="container mx-auto">
					...
					<div className="flex flex-col items-center gap-2">
						<p className="text-center text-red-500 text-sm md:text-base font-semibold animate-pulse">⚡ Only {Math.floor(Math.random() * 10) + 1} items left at this price!</p>
			...
			<div className="bg-gradient-to-r from-yellow-500/10 to-yellow-600/10 py-4">
				<div className="container mx-auto">
					<div className="flex flex-wrap items-center justify-center gap-6 text-sm">
						...
						<div className="flex items-center gap-2">
							<span className="text-yellow-600 text-xl">✨</span>
							<span className="font-medium">Statisfaction Guaranteed</span>
						</div>
						<div className="flex items-center gap-2">
							<span className="text-yellow-600 text-xl">🔒</span>
						...
						<div className="flex flex-col gap-2 mt-4">
							<div className="flex items-center gap-3">
								...
								<div className="flex flex-col">
									...
									<div className="flex items-center gap-2">
										<span className="bg-red-600 text-white px-2 py-0.5 rounded text-sm font-bold animate-pulse">-80%</span>
