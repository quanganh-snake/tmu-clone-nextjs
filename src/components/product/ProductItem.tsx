...
const ProductItem = ({ product }: TProductItemProps) => {
	return (
		<div className="grid-col-span-1">
			<div className="w-full bg-white rounded-lg overflow-hidden relative">
				...
				<div className="relative h-48 w-full">
					{product.image && <Image src={urlFor(product.image).width(256).url()} alt={product.title || "Product Image"} fill className="object-contain p-2" loading="lazy" />}
				</div>
				{/* END: Image */}

				<div className="p-4">
					<h3 className="text-sm font-medium line-clamp-2 h-10 mb-1">{product.title || "Product title is updating......"}</h3>
